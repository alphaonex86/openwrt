...
#define PI_DSCRUNOUT_DS	PI_X(0x0a0b4)
#undef  PI_DSCRUNOUT_US
#define PI_DSCRUNOUT_US	PI_X(0x020e0)
#undef  PI_IP_MSTBASE_US
#define PI_IP_MSTBASE_US	PI_X(0x020e8)
#undef  PI_PONIP_CTL_DS
#define PI_PONIP_CTL_DS	PI_X(0x0a0ac)
#undef  PI_PONIP_CTL_US
#define PI_PONIP_CTL_US	PI_X(0x020d8)
#undef  PI_PON_DSC_CFG_DS
#define PI_PON_DSC_CFG_DS	PI_X(0x0a0cc)
#undef  PI_PON_DSC_CFG_US
#define PI_PON_DSC_CFG_US	PI_X(0x0215c)
#undef  PI_PON_FC_CONFIG_DS
#define PI_PON_FC_CONFIG_DS	PI_X(0x0a0fc)
#undef  PI_PON_OMCI_CFG
#define PI_PON_OMCI_CFG	PI_X(0x02154)
#undef  PI_DRN_CMD
#define PI_DRN_CMD	PI_X(0x020e4)
#undef  PI_PON_OLT_BW_MTR_FULL
#define PI_PON_OLT_BW_MTR_FULL	PI_X(0x0218c)
#undef  PI_PON_WFQ_TYPE
#define PI_PON_WFQ_TYPE	PI_X(0x023e8)
#undef  PI_RSVD_PONIP_DS
#define PI_RSVD_PONIP_DS	PI_X(0x0a10c)
#undef  PI_PON_DSC_USAGE_DS
#define PI_PON_DSC_USAGE_DS	PI_X(0x0a0bc)
#undef  PI_PON_IPSTS_US
#define PI_PON_IPSTS_US	PI_X(0x020f4)
#undef  PI_PON_DSC_USAGE_US
#define PI_PON_DSC_USAGE_US	PI_X(0x020ec)
#undef  PI_PON_IPSTS_DS
#define PI_PON_IPSTS_DS	PI_X(0x0a0c0)
#undef  PI_PON_DSC_STS_DS
#define PI_PON_DSC_STS_DS	PI_X(0x0a0c8)
#undef  PI_PON_SID2QID
#define PI_PON_SID2QID	PI_X(0x020f8)
#undef  PI_PON_SIDVALID
#define PI_PON_SIDVALID	PI_X(0x0213c)
#undef  PI_PON_SID_GLB_TH
#define PI_PON_SID_GLB_TH	PI_X(0x02454)
#undef  PI_PON_SID_Q_MAP_DS
#define PI_PON_SID_Q_MAP_DS	PI_X(0x0a0e4)
#undef  PI_PON_SID_RPV_TH
#define PI_PON_SID_RPV_TH	PI_X(0x02458)
#undef  PI_PON_SID_STOP_TH
#define PI_PON_SID_STOP_TH	PI_X(0x02450)
#undef  PI_PON_US_FIFO_CTL
#define PI_PON_US_FIFO_CTL	PI_X(0x020f0)
