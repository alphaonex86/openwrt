...
#define GPON_AES_KEY_SWITCH_TIME	0x03014
...
static const struct gpon_chip luna_gpon_chip = {
	...
	.gtc = {
		 ...
		 * chipdefs (RTL9602C and RTL9603CVD), so the family-invariant
		 * claim of this table holds for them too.  The idx masks are
