 ...
 * correct rev-A value. A/B via bootarg gpon_rtl9602c.pir_drop=1. */
 ...
 * pages -> grants once then stops -> gemus64=0. Default on; A/B via gpon_rtl9602c.dbru_blksize=0. */
